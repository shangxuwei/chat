...
# 第5步，用户信息
tk.Label(window, text='User name:', font=('Arial', 14)).place(x=10, y=50)
tk.Label(window, text='Password:', font=('Arial', 14)).place(x=10, y=90)
...
entry_usr_name.place(x=120, y=55)
# 用户密码
var_usr_pwd = tk.StringVar()
entry_usr_pwd = tk.Entry(window, textvariable=var_usr_pwd, font=('Arial', 14), show='*')
entry_usr_pwd.place(x=120, y=95)
...
def usr_login():
    ...
    if usr_name in usrs_info:
        if usr_pwd == usrs_info[usr_name]:
            ...
            init_window = tk.Tk()
            ZMJ_PORTAL = login.MY_GUI(init_window)
